...
interface GameContextType {
  ...
  totalProduction: Resources; steelProduction: number;
  allVillages: PlayerVillage[]; loading: boolean;
  ...
  rations: RationsLevel; setRations: (r: RationsLevel) => void;
  popTaxRate: number; setPopTaxRate: (r: number) => void;
  ...
  spies: number; trainSpies: (count: number) => boolean;
  ...
  injuredTroops: InjuredArmy; poisons: number;
  healTroops: (type: TroopType, count: number) => boolean;
  craftPoison: (count: number) => boolean;
  getApothecaryLevel: () => number; storageCapacity: number;
