    ...
    <div className="game-panel border-glow rounded-xl p-3 space-y-2">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[9px] text-muted-foreground">Tribute: {vassalage.tribute_rate}% · Ransom: {vassalage.ransom_gold}💰</p>
        </div>
      ...
      {editingRate ? (
        <div className="space-y-1.5">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-xs font-bold text-foreground w-10 text-right">{rate}%</span>
          </div>
          <div className="flex gap-1.5">
            <motion.button
              ...
              className="flex-1 font-display text-[10px] py-1.5 rounded-lg bg-primary/20 text-primary"
            >
              ✓ Save
            </motion.button>
            <motion.button
              ...
              className="flex-1 font-display text-[10px] py-1.5 rounded-lg bg-muted text-muted-foreground"
            >
              ✕ Cancel
            </motion.button>
          </div>
        ...
        <div className="flex gap-1.5">
          ...
          <motion.button
            ...
            className="flex-1 font-display text-[10px] py-1.5 rounded-lg bg-destructive/20 text-destructive"
          >
            🕊️ Release
          </motion.button>
        </div>
