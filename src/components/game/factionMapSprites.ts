...
import vikingMapFort from '@/assets/sprites/factions/viking/map-fort.png';
...
import samuraiMapFort from '@/assets/sprites/factions/samurai/map-fort.png';
...
import undeadMapFort from '@/assets/sprites/factions/undead/map-fort.png';
...
import romanMapFort from '@/assets/sprites/factions/roman/map-fort.png';
...
import pirateMapFort from '@/assets/sprites/factions/pirate/map-fort.png';
...
export const FACTION_FORT_SPRITES: Record<string, string> = {
  viking: vikingMapFort,
  samurai: samuraiMapFort,
